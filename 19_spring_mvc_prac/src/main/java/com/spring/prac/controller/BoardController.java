...
import com.spring.prac.service.BoardSerivice;
...
public class BoardController {
	...
	@Autowired
	private BoardSerivice boardService;
	...
	public ModelAndView modifyBoard(@ModelAttribute("boardId") long boardId) {
	...
	public String modifyBoard(@ModelAttribute BoardDTO boardDTO) {
		...
		if(boardService.boardUpdate(boardDTO)) {
			jsScript = "<script>";
			jsScript +="alert('Update Successful!');";
			jsScript +="location.href='boardList';";
			jsScript +="</script>";
	...
	public String removeBoard(@ModelAttribute BoardDTO boardDTO) {
		...
		if(boardService.removeBoard(boardDTO)) {
			...
			jsScript = "<script>";
			jsScript +="alert('Delete Successful!');";
			jsScript +="location.href='boardList';";
			jsScript +="</script>";
